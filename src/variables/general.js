...
export const rtlDashboardTableData = [
  ...
  {
    logo: SpotifyLogo,
    name: "Launch of our mobile application",
    members: [avatar2, avatar3, avatar7, avatar8],
    budget: "$32,000",
    progression: 100,
  },
  ...
  {
    logo: InvisionLogo,
    name: "Redesign of a new online store",
    members: [avatar9, avatar3, avatar2],
    budget: "$7,600",
    progression: 40,
  },
...
export const rtlTimelineData = [
  ...
  {
    logo: FaCreditCard,
    title: "Added a new card for order #3210145",
    date: "20 DEC 3:52 PM",
    color: "orange.300",
  },
  {
    logo: SiDropbox,
    title: "Opening Packages for Development",
    date: "19 DEC 11:35 PM",
    color: "purple",
  },
  {
